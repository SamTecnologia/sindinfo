...
?>
			...
			{
				$erro = 1;
				echo "<script>alert('CNPJ'.$cnpj.' é invalido, verifique o nome do seu arquivo<br />
				O arquivo deve ser no formato: CNPJ_ano.txt ou seja 11111111111111_2013.txt'); history.back();</script>"; die;
			}
			//Etapa 3: O número 00000000000 embora não seja um cnpj real resultaria um cnpj válido após o calculo dos dígitos verificares e por isso precisa ser filtradas nesta etapa.
			if ($num[0]==0 && $num[1]==0 && $num[2]==0 && $num[3]==0 && $num[4]==0 && $num[5]==0 && $num[6]==0 && $num[7]==0 && $num[8]==0 && $num[9]==0 && $num[10]==0 && $num[11]==0)
			{
				echo 'Não é permitido o CNPJ: 00000000000000. Verifique!';
			}	